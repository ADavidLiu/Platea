...
<nav class="navbar navbar-fixed-top nav">
    <div class="navbar-header navbar-default">
        <div class="row">
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 nav__menu" >
                ...
                <div class="col-xs-9 col-sm-9 col-lg-9 ">
                    <a class="brand" href="<?php echo $global['webSiteRootURL']; ?>" style="font-weight: 300; color: #333; text-decoration: none;">
                        Platea<span style="color: #fff; font-weight: 400; display: inline-block; padding: 2px 10px; background-color: #f00000; border-radius: 3px;">Player</span>
                        <!-- <img src="<?php /* echo $global['webSiteRootURL'], $config->getLogo(); */ ?>" alt="<?php /* echo $config->getWebSiteTitle(); */ ?>" class="img-responsive"> -->
                    </a>
                </div>
            </div>
            <div class="col-xs-6 col-sm-3 col-sm-push-5 col-md-push-6 col-lg-2 col-lg-push-8 nav__btns" style="padding-top: 8px;" >
                <a href="<?php echo $global['webSiteRootURL']; ?>upload" class="cargar-btn btn btn-danger"><i class="fa fa-upload"></i> Cargar</a>
            ...
            <div class="col-xs-12 col-sm-5 col-sm-pull-3 col-sm-offset-0 col-md-6 col-lg-8 col-lg-pull-2 nav__search" >
                <form class="navbar-form  " action="<?php echo $global['webSiteRootURL']; ?>" >
                    <div class="input-group"  style="width: 100%; display: flex; align-items: stretch; justify-content: space-between;">
                        <input class="form-control" type="text" name="search" placeholder="<?php echo __("Search"); ?>">
                        <button class="input-group-addon" type="submit" style="width: 50px; display: inline-block;"><span class="glyphicon glyphicon-search"></span></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="navbar-collapse collapse  col-xs-12 col-sm-12 col-lg-2">
        <a href="<?php echo $global['webSiteRootURL']; ?>upload" class="btn btn-success btn-block navbar-btn" style="border-color: #f00000; background-color: #f00000;">
